...

{
  ...
  boot.initrd.luks.devices."luks-f9a7e3fb-c7e9-45d0-bc5e-b2258aefc5de".device =
    "/dev/disk/by-uuid/f9a7e3fb-c7e9-45d0-bc5e-b2258aefc5de";
  ...
  boot.initrd.luks.devices."luks-dcc35be9-edc4-4589-8dae-84d62df0012a".device =
    "/dev/disk/by-uuid/dcc35be9-edc4-4589-8dae-84d62df0012a";
